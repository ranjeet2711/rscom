...
SECRET_KEY = 'bmw(n%5*it17elftx#0k5+xohz)2-63rfbwj)it(0a3rl!009t'
...
EMAIL_HOST_USER = 'hungry@gmail.com' # sendgrid
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'yourpsword')
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
MANAGERS = (
    ('Justin Mitchel', "hurypy@gmail.com"),
)
